...
<html lang="en">
<head>
   <title>Zombie Bank - Sabka Saath Sabka Vinaash</title>
   <meta charset="utf-8">
...
<div  class="col-lg-6 col-md-6 col-12">
      <img src="images/one1.jpg" class="img-fluid">
      </div>
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>Sparks Bank</h1>
      <p1> <!-- Zombie Bank is a part of Zombie foundation. It is one of Znations's leading private banks and was among the first to receive approval from the Central bank of Znation (CBZ) to set up a private sector bank in 992 ZY.
          ...
          A bank is a financial institution licensed to receive deposits and make loans. It is one of Znations's leading private banks and was among the first to receive approval from the Central bank of Znation (CBZ) to set up a private sector bank in 992 ZY. Banks may also provide financial services such as wealth management, currency exchange, and safe deposit boxes. There are several different kinds of banks including retail banks, commercial or corporate banks, and investment banks. 
...
<footer class="text-center mt-2 py-5">
        <p>&copy 2021  <b>Bhaskar Kumar</b> </br>Chairman, Sparks Bank</p>
      </footer>
